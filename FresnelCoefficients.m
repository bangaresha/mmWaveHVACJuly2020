...
% in the air). So with all these simplifications the refractive index (n) simplifies to 
% the permittivity.it's only the permittivity that is important.
% er is the epsilon (E) of the second material (1st is always air in radio propagation) and 
% therefore discarded from input. 
...
er = sqrt(eta); % converting permittivity to refractive index
theta = theta1;
